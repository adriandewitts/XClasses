...
extension UIAlertController {
    ...
    public convenience init(title: String, message: String? = nil,
        ...
        class TextFieldObserver: NSObject, UITextFieldDelegate {
            ...
            let textFieldshouldChange: ((String) -> Bool)?
            
            init(textField: UITextField, valueChanged: @escaping (UITextField) -> Void, shouldReturn: @escaping (UITextField) -> Bool, shouldChange: ((String) -> Bool)? = nil) {
                self.textFieldValueChanged = valueChanged
                self.textFieldShouldReturn = shouldReturn
                self.textFieldshouldChange = shouldChange
                super.init()
            ...
            func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
                guard let value = textFieldshouldChange?(string) else {
                    return true
                }
        ...
        addTextField(configurationHandler: { textField in
            ...
            }, shouldChange: textFieldshouldChange)
        })
